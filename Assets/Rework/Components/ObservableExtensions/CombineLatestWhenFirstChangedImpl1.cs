...
namespace Selania.Rework.Components.ObservableExtensions
{
    ...
    public sealed class CombineLatestWhenFirstChangedImpl1<TDriver, T1, TResult> : Observable<TResult>
    {
        /// <summary>
        ...
        public CombineLatestWhenFirstChangedImpl1(
        ...
        {
            /// <summary>
            ///     The driver observable (see <see cref="CombineLatestWhenFirstChangedImpl1{TDriver,T1,TResult}._driver" />).
            /// </summary>
            private readonly Observable<TDriver> _driver;
            ...
            ///     <see cref="CombineLatestWhenFirstChangedImpl1{TDriver,T1,TResult}._resultSelector" />).
            /// </summary>
            private readonly Func<TDriver, T1, TResult> _resultSelector;

            /// <summary>
            ///     The first source observable (see <see cref="CombineLatestWhenFirstChangedImpl1{TDriver,T1,TResult}._source1" />).
            /// </summary>
            private readonly Observable<T1> _source1;
