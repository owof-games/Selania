...
//Così se decido di uscire dalla conversazione, posso riprendere da dove eravamo rimaste.
    ...
    {charTag(PG, "neutral")}:                               Hai detto che da quando nonna è nella casa dei vecchi fa tutto schifo.
        ...
        + \ {charTag(PG, "neutral")}:                       Ma nonna ti ha anche insegnato ad essere curioso.
                -> glyph_choice_manager(false, airC)->
        {charTag(PG, "neutral")}:                           E con la curiosità puoi affrontare le cose più difficili.
                                                            Come accettare che una persona anziana ha bisogno di cure, {charNameTwo}.
    ...
    + \ {charTag(PG, "neutral")}:                           O forse sei solo curioso e sveglio, e pronto al cambiamento.
            -> glyph_choice_manager(false, airC)->
    ...
    //renderla più interessante  
    + \ {charTag(PG, "neutral")}:                           Eppure tuo fratello ripara macchine, crea statue, lascia libera la tua curiosità.
        -> glyph_choice_manager(false, airC)->
    ...
    {charTag(PG, "neutral")}:                               Hai detto che i grandi fanno schifo, e che non vuoi diventare grande.
        ...
        + \ {charTag(PG, "neutral")}:                       Ma puoi essere un adulto curioso e studioso come il bambino che sei ora.
            -> glyph_choice_manager(false, airC)->
        {
    ...
    {charTag(PG, "neutral")}:                           Credo di aver compreso quale sia il tuo blocco, perché sei qui.
                                                        ...
                                                        Ti sembrano tutti molto incasinati e complicati e infelici.
                                                        E poi se chi dovrebbe proteggerti ti ha ferito, come fai a fidarti delle persone?
    ...
    -> rewriting_witch_feedback(endR) ->    
        ...
        + (air)\ {charTag(PG, "neutral")}:              Con la tua intelligenza e la tua curiosità puoi rendere il mondo migliore.
        -> glyph_choice_manager(false, airC)->
        {charTag(PG, "neutral")}:                       Puoi aiutare gli adulti a essere meno tristi.
                                                        E gli animali a non morire.
                                                        O fare più felice un altro {charNameTwo}.
        -
