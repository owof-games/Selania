/* ---------------------------------
 ...
 === support
    ...
    - (top)
    Hai bisogno dei miei consigli?#speaker:{fifthChar_tag()} 
    ...
    = myself
    ~ temp charNameFive = translator(fifthCharacterState)
    C'è qualcosa che posso fare per aiutarti?#speaker:{fifthChar_tag()} 
...
//Strutturare come wave sintetica?
    Ecco i luoghi che puoi visitare in questo momento.#speaker:{fifthChar_tag()} 
...
~ temp charNameFive = translator(fifthCharacterState)
        ...
        {gifts_and_ink:La prima cosa da fare è: conquistare la <b>fiducia</b> della persona che devi aiutare.}#speaker:{fifthChar_tag()} 
 ...
 ~ temp charNameFive = translator(fifthCharacterState)
    ...
    Questi sono i principali temi delicati che potresti incontrare durante le tue chiacchierate.#speaker:{fifthChar_tag()} 
 ...
 === elementi_serra
  ~ temp charNameFive = translator(fifthCharacterState)
    Come posso aiutarti, {name}?#speaker:{fifthChar_tag()} 
    {
 ...
 
 {
    ...
    = two
     ~ temp charNameFive = translator(fifthCharacterState)
        ...
        Ci sono volte in cui mi focalizzo solo sulle cose che non vanno.#speaker:{fifthChar_tag()} 
    ...
    = three
     ...
     Un tempo conoscevo una ragazza che soffriva di attacchi d'ansia e che mi ha dato una dritta che puoi applicare ovunque.#speaker:{fifthChar_tag()} 
    ...
    Il mio migliore amico è il body scan.#speaker:{fifthChar_tag()} 
    ...
    Non so se ti capita di avere l'addome contratto. #speaker:{fifthChar_tag()} 
