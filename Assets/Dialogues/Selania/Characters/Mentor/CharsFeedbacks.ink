    ...
    ~ temp charNameFive = translator(fifthChar_ActualName)
...

        {
            ...
            - firstChar_ActualName ==  FlautoDolce:
                ...
                {charTag(FifthCharacter, "hurry")}:         Mettere al centro della propria vita le altre persone, non è cosa da tutt3.
                {charTag(FifthCharacter, "neutral")}:       E la propria passione.
