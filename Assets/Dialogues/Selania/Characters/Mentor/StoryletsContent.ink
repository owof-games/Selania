...
//Fine della demo
    ...
    - (repeat)
    Il codice è {playerPurple} - {playerYellow} - {playerBlue} - {playerGreen}- {playerRed}; {playerFirstStory}; {playerSecondStory}; {firstCharacterState}; {secondCharacterState}; {backupCultivable}; {readStories}.
