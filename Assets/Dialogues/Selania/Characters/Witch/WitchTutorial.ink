=== tutorial_witchRelationship
    ...
    ~ temp mentorName = translator(mentor_ActualName)
        ...
        {charTag(witch_tag(), witch_state())}   <i>Quando vi siete conosciut3, {mentorName} ha detto a {player_name} che le cose che dice alle persone sono un modo di vedere il mondo.
        ...
        <i>Il lichene prospera perché i bisogni si sovrappongono, non perché l'alga è uguale al fungo.</i>
                ...
                + Sono sicur{player_pronouns has him:o|{player_pronouns has her:a|ə}} che {mentorName} avesse le migliori intenzioni.
                    ...
                    {charTag(witch_tag(), witch_state())}   <i>{player_name} risplende nella sua empatia.
                ...
                + È ciò che facciamo per l'altrə che conta, non quello che diciamo.
                    ...
                    {charTag(witch_tag(), witch_state())}   <i>La falena plana per raggiungere la compagna.
                ...
                + Il modo in cui viviamo riflette il mondo per come lo guardiamo.
                    ...
                    {charTag(witch_tag(), witch_state())}   <i>Il modo in cui {player_name} vive riflette il mondo per come lo guarda.
                ...
                + Ma in concreto, non sono due modi diversi per dire la stessa cosa?
                    ...
                    {charTag(witch_tag(), witch_state())}   <i>Il cucciolo affonda i denti nel fratellino.
                ...
                + Siamo uman3, e la nostra crescita prospera nella contraddizione.
                    ...
                    {charTag(witch_tag(), witch_state())}   <i>Ricordo poco della vita umana, ma la natura stessa prospera nel tentativo, nell'errore.
...
=== tutorial_witchSigils
    ...
    {charTag(witch_tag(), witch_state())}   <i>Il Nido è accessibile, il nostro cuore brucia.
    ...
    <i>{player_name} conosce il confine tra strumento e manipolazione?</i>
            ...
            + Solo il tempo conosce le risposte.
                    -> glyph_modifier_variation_management(PG, earthC)->
                {charTag(witch_tag(), witch_state())}   <i>Il tempo porta le risposte che vogliamo vedere.
            ...
            + Basta chiedersi "questa cosa farà bene all'altrə?".
                    -> glyph_modifier_variation_management(PG, waterC)->
                {charTag(witch_tag(), witch_state())}   <i>Il Ministro scatena la guerra per il bene del paese.
                <i>In migliaia muoiono al fronte.</i>
                
            + Ci sono parti di me che mi rimangono ignote.
                    -> glyph_modifier_variation_management(PG, aetherC)->
                {charTag(witch_tag(), witch_state())}   <i>La pianta si accresce con lentezza in molteplici direzioni.
                <i>Il lusso di non rispondere delle proprie azioni.</i>

            + La mia volontà è forte, è quello che conta.
                    -> glyph_modifier_variation_management(PG, fireC)->
                {charTag(witch_tag(), witch_state())}   <i>La roccia inamovibile, scivola di millimetro in millimetro verso l'abisso.</i>
                
            + La risposta logica risiede nell'intenzione.
                    -> glyph_modifier_variation_management(PG, airC)->
                {charTag(witch_tag(), witch_state())}   <i>Con forte intenzione Icaro volò verso il sole.
...
=== about_the_book
    ...
    ~ temp charNameFive = translator(mentor_ActualName)
        ...
        {charTag(witch_tag(), witch_state())}   <i>Un libro è ricordo condiviso.
