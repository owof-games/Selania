=== function strings_francoMissions()
    ...
    {frog_currentMission:
        ...
        - missionEight:
            ~ return "Franco ha chiesto a {player_name} di leggere qualcosa in biblioteca."

        - missionNine:
            ~ return "Franco ha chiesto a {player_name} di guardare il ritratto che è in camera sua."

        - missionTen:
            ~ return "Franco ha chiesto a {player_name} di aggiungere un ingrediente extra mentre cucina."                
        
        - specialMissionOne:
            ~ return "Franco ha detto a {player_name} di raggiungerlo al Nido."
