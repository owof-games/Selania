...
- (top)
    ...
    + {glyph_discoveredSigils has EarthWaterFire && leftSigilName == "EarthAir"}[{sigils_translator(EarthWaterFire)} #position:right1 #glyph3:{grimoire_sigilGlyph3(EarthWaterFire)} #firstLine:{grimoire_textEarthWaterFireOne} #secondLine:{grimoire_textEarthWaterFireTwo} #thirdLine:{grimoire_textEarthWaterFireThree} #status:{grimoire_statusThirdSigils(EarthWaterFire)} #grimoire-traversal:dont-visit]
        ~ glyph_actualActiveSigil += EarthWaterFire
        ~ glyph_actualSigilUses = glyph_maxSigilUses
    + {glyph_discoveredSigils has EarthWaterAether && leftSigilName == "EarthAir"}[{sigils_translator(EarthWaterAether)} #position:right2 #glyph3:{grimoire_sigilGlyph3(EarthWaterAether)} #firstLine:{grimoire_textEarthWaterAetherOne} #secondLine:{grimoire_textEarthWaterAetherTwo} #thirdLine:{grimoire_textEarthWaterAetherThree} #status:{grimoire_statusThirdSigils(EarthWaterAether)} #grimoire-traversal:dont-visit]
        ~ glyph_actualActiveSigil += EarthWaterAether
        ~ glyph_actualSigilUses = glyph_maxSigilUses
    + {glyph_discoveredSigils has EarthWaterAir && leftSigilName == "EarthAir"}[{sigils_translator(EarthWaterAir)} #position:right3 #glyph3:{grimoire_sigilGlyph3(EarthWaterAir)} #firstLine:{grimoire_textEarthWaterAirOne} #secondLine:{grimoire_textEarthWaterAirTwo} #thirdLine:{grimoire_textEarthWaterAirThree} #status:{grimoire_statusThirdSigils(EarthWaterAir)} #grimoire-traversal:dont-visit]
        ~ glyph_actualActiveSigil += EarthWaterAir
        ~ glyph_actualSigilUses = glyph_maxSigilUses

    + {glyph_discoveredSigils has EarthAetherAir && leftSigilName == "EarthFire"}[{sigils_translator(EarthAetherAir)} #position:right1 #glyph3:{grimoire_sigilGlyph3(EarthAetherAir)} #firstLine:{grimoire_textEarthAetherAirOne} #secondLine:{grimoire_textEarthAetherAirTwo} #thirdLine:{grimoire_textEarthAetherAirThree} #status:{grimoire_statusThirdSigils(EarthAetherAir)} #grimoire-traversal:dont-visit]
        ~ glyph_actualActiveSigil += EarthAetherAir
        ~ glyph_actualSigilUses = glyph_maxSigilUses
    + {glyph_discoveredSigils has EarthAetherFire && leftSigilName == "EarthFire"}[{sigils_translator(EarthAetherFire)} #position:right2 #glyph3:{grimoire_sigilGlyph3(EarthAetherFire)} #firstLine:{grimoire_textEarthAetherFireOne} #secondLine:{grimoire_textEarthAetherFireTwo} #thirdLine:{grimoire_textEarthAetherFireThree} #status:{grimoire_statusThirdSigils(EarthAetherFire)} #grimoire-traversal:dont-visit]
    ...
    + {glyph_discoveredSigils has AetherFireWater && leftSigilName == "AetherEarth"}[{sigils_translator(AetherFireWater)} #position:right1 #glyph3:{grimoire_sigilGlyph3(AetherFireWater)} #firstLine:{grimoire_textAetherFireWaterOne} #secondLine:{grimoire_textAetherFireWaterTwo} #thirdLine:{grimoire_textAetherFireWaterThree} #status:{grimoire_statusThirdSigils(AetherFireWater)} #grimoire-traversal:dont-visit]
        ...
        ~ glyph_actualSigilUses = glyph_maxSigilUses
    + {glyph_discoveredSigils has AetherFireAir && leftSigilName == "AetherEarth"}[{sigils_translator(AetherFireAir)} #position:right2 #glyph3:{grimoire_sigilGlyph3(AetherFireAir)} #firstLine:{grimoire_textAetherFireAirOne} #secondLine:{grimoire_textAetherFireAirTwo} #thirdLine:{grimoire_textAetherFireAirThree} #status:{grimoire_statusThirdSigils(AetherFireAir)} #grimoire-traversal:dont-visit]
        ~ glyph_actualActiveSigil += AetherFireAir
        ~ glyph_actualSigilUses = glyph_maxSigilUses
    + {glyph_discoveredSigils has AetherFireEarth && leftSigilName == "AetherEarth"}[{sigils_translator(AetherFireEarth)} #position:right3 #glyph3:{grimoire_sigilGlyph3(AetherFireEarth)} #firstLine:{grimoire_textAetherFireEarthOne} #secondLine:{grimoire_textAetherFireEarthTwo} #thirdLine:{grimoire_textAetherFireEarthThree} #status:{grimoire_statusThirdSigils(AetherFireEarth)} #grimoire-traversal:dont-visit]
