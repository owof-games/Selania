...
//Storylets Mostro
    grimFifthCharOne, grimFifthCharPresentation, grimFifthCharTwo, grimFifthCharThree, grimFifthCharFour, grimFifthCharFive, grimFifthCharSix, grimFifthCharNovel, grimFifthCharDog, grimFifthCharKitchenOne, grimFifthCharKitchenTwo, grimFifthCharKitchenThree, grimFifthCharKitchenEnded, grimFifthCharKitchenPositiveReaction, grimFifthCharKitchenNegativeReaction, grimFifthCharKitchenNeutralReaction,grimFifthCharKitchenAlone, grimFifthCharProposal, grimFifthCharNewName, grimFifthCharMentorFeedback, grimFifthCharLetterOne, grimFifthCharLetterTwo, grimFifthCharLetterThree, grimFifthCharLetterFour,

//Storylets Mentore
    grimMentorIntro, grimMentorOne, grimMentorPresentation, grimMentorTwo, grimMentorThree, grimMentorFour, grimMentorFive, grimMentorSix, grimMentorNovel, grimMentorDog, grimMentorLiar, grimMentorViolence, grimMentorOlobinoUno, grimMentorOlobinoDue, grimKitchenMentor, grimMentorMeltdown, grimMentorNotMandatory, grimMentorNewMail, grimMentorFirstSecretEnding, grimMentorSecondSecretEnding, grimMentorThirdSecretEnding, grimMentorFourthSecretEnding, grimMentorFifthSecretEnding,

//Storylets strega
    grimWitchFirstDebrief, grimWitchSecondDebrief, grimWitchThirdDebrief, grimWitchFourthDebrief, grimWitchFifthDebrief, grimWitchIntro, grimWitchFrog, grimWitchMainOne, grimWitchMainTwo, grimWitchMainThree, grimWitchMainFour, grimWitchMainFive, grimWitchBook, grimWitchOpenDump, grimWitchAllSigilsOpened, grimWitchAboutAppendices, grimWitchNotificationChoice,

//Storylets Franco
    grimFrancoFirst, grimFrancoAllDocuments, grimFrancoSpecialMissionOneFeedback, grimFrancoThirdIngredientFailure,

//Common Storylets
    grimFirstSecondChar, grimFirstThirdChar, grimFirstCharMentor, grimFirstCharMentorAboutThirdChar, grimFirstCharFranco, grimSecondCharMentorOne, grimSecondCharMentorPeace, grimSecondThirdChar, grimSecondCharFranco, grimThirdCharFranco, grimThirdCharMentor, grimWitchThirdChar, grimWitchThirdCharNo, grimMentorFranco, grimMentorWitchOne, grimFourthFifthChar, grimFourthCharFranco, grimFifthCharFranco, grimMonsterMolotovOne, grimMonsterMolotovTwo, grimMonsterMolotovThree, grimMonsterMolotovFour, grimMonsterMolotovFive, grimMonsterMolotovSix
