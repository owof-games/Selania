...
//Poi faccio un check lato pausa dialogo, perché se c'è la pausa, non c'è nessuno storylet
...

    {
        ...
        - are_two_entities_together(PG, Carla) && tutorial_CarlaTutorial == true && tutorial_CarlaDiscoveredTutorials has tutorialNest && tutorial_CarlaDiscoveredTutorials hasnt tutorialSigils && tutorial_CarlaTutorial == true:
