...
{
    - secondChar_giftedObject != (): <b><i>Appunti su dono e riscrittura.</b></i><N><>
}

    {

        - grimoire_secondChar has grimSecondCharMentorFeedback: Dopo aver aiutato {charNameTwo}, Mentor ha detto a {player_name} che <>
                {
                    - secondChar_ActualName has Grizzly:
    ...
    {grimoire_secondChar has grimSecondCharNewName: Dopo la conversazione con {player_name}, {charNameTwo} ha scelto un nuovo nome: <b><i>{charNameTwo}.}
