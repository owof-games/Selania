...
{
    - first_character_feedback.bookUpdate: Mentore dice che <>
...
{rewriting_proposal_first_character.close.bookUpdate: Dopo la Riscrittura, ha scelto un nuovo nome: <b><i>{translator(firstChar_ActualName)}.</b></i>}
