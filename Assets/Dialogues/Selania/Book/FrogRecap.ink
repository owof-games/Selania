...
Franco la rana vuole aiutare {player_name} nel suo percorso. <N><>
    ...
    {frog_currentMission:
        ...
        - missionTwo:
            Franco ha chiesto a {player_name} di coltivare almeno tre piante alla serra prima di tornare da lui.
