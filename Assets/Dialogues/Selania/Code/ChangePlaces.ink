...
//Streets to and into the Bedroom
    ...
    + {are_two_entities_together(PG, RoomExit) && (not debugStochastic)} [RoomExit]
            ...
            <i>Il codice è {playerPurple} - {playerYellow} - {playerBlue} - {playerGreen}- {playerRed}; {playerFirstStory}; {playerSecondStory}; {firstCharacterState}; {secondCharacterState}; {backupCultivable}; {readStories}.
            <i>Grazie di cuore.
