//Lista dei contenuti di un determinato luogo, in modo da tracciare chi è dove
    VAR contentsBedroom = (FromBedroomToTrainStop, PG, Settings, Carla)
