//Lista dei contenuti di un determinato luogo, in modo da tracciare chi è dove
    ...
    VAR contentsSafekeeping = (BedClosingGame, FirstCharacter, SecondCharacter, ThirdCharacter, FourthCharacter, FifthCharacter, DoggoFirstLetters, DoggoSecondLetters, DoggoThirdLetters, DoggoFourthLetters, Franco, DoggoFifthLetters, MenuSave, MenuQuit,  Grimoire, FirstRecap, SecondRecap, ThirdRecap, FourthRecap, FrogRecap, DogRecap, WitchRecap, GreenhouseRecap, KitchenRecap, NestRecap, FifthRecap, RulesRecap, greenhouseOpened, firstCharPaint, kitchenOpened, libraryOpened, secondCharPaint, FromLibraryToNest, FromForestToLibrary, RedBee, GoldenBee, BrownBee, NightMode, Snail, FromPondToGreenhouseBlooming, TrainNoiseComing, BastonSound, NewMoonAnim, FirstQuarterAnim, FullMoonAnim, ThirdQuarterAnim, RedMoonAnim, Mentor, FromPondToKitchen, FromPondToGreenhouse, KitchenFire, CookingWithFirstCharOBJ, CookingWithSecondCharOBJ, FirstCharCookingAloneOBJ,  EatingWithSecondCharOBJ, EatingWithFirstCharOBJ, Bat, BatHouseFront, BatHouseRetro, TrainNoiseGoingAway, StartingNote, DoggoNoLetters, FromForestToDump, firstDumpOBJ, secondDumpOBJ, thirdDumpOBJ, fourthDumpOBJ, fifthDumpOBJ, fireGlyph, earthGlyph, Carla, CookingWithThirdCharOBJ, EatingWithThirdCharOBJ, ThirdCharCookingAloneOBJ, aetherGlyph_off, airGlyph_off, fireGlyph_off, earthGlyph_off, waterGlyph_off, mapDump, mapKitchen, mapGreenhouse, mapLibrary, mapNest, docDump, docKitchen, docGreenhouse, docNest, docLibrary, Clothespin, nestOpened, francoOpened, dumpOpened, thirdCharPaint, fourthCharPaint, fifthCharPaint, CookingWithFourthCharOBJ, EatingWithFourthCharOBJ, CookingWithFifthCharOBJ, EatingWithFifthCharOBJ, FourthCharCookingAloneOBJ, FifthCharCookingAloneOBJ)
