...
<b>Il principe sbagliato</b> di Sofia Abatangelo alias Romi alias Romi Sofia Abatangelo(any).<N>Instagram: @romiabatangelo<N>Trigger warning: violenza psicologica.#speaker:{witch_tag()} #inkA:offState #inkB:offState #inkC:offState #inkD:offState #portrait:{witch_state()}
    ...
    C’era una volta un principe che non ne faceva mai un giusta.<N>Il suo modo di muoversi era sbagliato, il suo modo di vestirsi era sbagliato, il suo modo di parlare era sbagliato.<N>Anche il suo modo di pensare era completamente sbagliato.<N>Ma la cosa più sbagliata del principe erano le sue emozioni.<N>A volte rideva, piangeva o si arrabbiava per un nonnulla, mentre altre volte il suo volto rimaneva impassibile quando invece avrebbe dovuto animarsi. <N>Così, anche se era un principe, ogni persona della sua corte - dal consigliere allo stalliere, dalla regina alla sguattera di cucina - non faceva che dirgli come muoversi, come vestirsi, come camminare, come parlare, e perfino quello che avrebbe dovuto sentire e pensare.
    
    Il principe cercava in tutti i modi di seguire i consigli che gli venivano dati, ma per quanto ci provasse finiva sempre per sbagliare tutto lo stesso.<N>Così gli anni passarono e il principe non divenne mai re.<N>Si era circondato di consiglieri che potessero insegnargli a comportarsi come un principe.<N>Ma questi o si seccavano quando lui non capiva e finivano per abbandonarlo, oppure, con la scusa che era sbagliato, gli davano ordini come se fosse un domestico, punendolo quando non riusciva ad eseguirli.<N>E fu così che il principe venne scacciato dal suo stesso castello e si trovò rinchiuso nelle segrete.
    
    I giorni passarono, i mesi passarono, gli anni passarono, e il principe se ne stava buono buono nella sua cella, cercando di non farsi vedere né sentire, finendo per convincersi di non meritare altro che quella vita da recluso<N>Finché un giorno ci fu un terremoto che aprì uno squarcio nel muro, verso una zona delle segrete che non aveva mai esplorato prima.<N>Il principe vagò a lungo, cercando una via di uscita da quello che sembrava diventato un labirinto, senza riuscire ad andare nè avanti nè indietro, finché un giorno non si trovò davanti a una grossa porta di ferro battuto dipinta di rosso.<N>A quella vista il cuore del principe si riempì di coraggio e la porta, pur pesantissima, si mosse facilmente al tocco delicato del principe, come se lo stesse aspettando.
    
    Il principe si trovò nell’armeria del castello, dove erano custodite tutte le armi che gli erano destinate per diritto di nascita ma che, siccome era sbagliato, nessuno gli aveva mai permesso di toccare.<N>La sua attenzione venne catturata da una lunga spada dorata, brillante come il sole.<N>Il principe la prese, finalmente senza che nessuno potesse impedirgli di farlo, e quando la impugnò fu come se un fuoco gli si fosse acceso dentro.<N>Così,con la spada in pugno, il principe uscì dall'armeria e vide davanti a sé una scala che lo portò fuori dalle segrete poi 
    sempre più su, <N>nelle cucine del castello dove il cuoco gli aveva detto di smettere di fare i capricci e mangiare senza fare tante storie, nella biblioteca dove i precettori gli dicevano che <N>pensava troppo e ubbidiva poco, fino alle stanze reali, dove aveva sentito il Re dire alla Regina che si vergognava di lui.<N>E con la spada in mano si riprese tutto ciò che gli apparteneva di diritto.
