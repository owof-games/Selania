...
=== cooking_with_second_char
    ...
    {charTag(PG, "neutral")}:                           In particolare, ripensando alle nostre conversazioni, mi farebbe piacere parlare di più... 
    {
        ...
        {charTag(TheWitch, witch_state())}:             <i>{charNameTwo} ha altri temi che vorrebbe condividere con {player_name}, ma vorrebbe che {player_name} prima conoscesse {charNameTwo} un po' meglio.</i>
    }
