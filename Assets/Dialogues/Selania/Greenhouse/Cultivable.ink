...
//Outcome: allontana qualcuno.
    = step_zero
        ~ growthLicheneDegliAbissi = stepZero
        <i>Qualcosa vortica sopra al vaso.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>La terra si accumla ai lati, lasciando un incavo nel terreno.</i>
        -> main
    
    = step_uno
        <i>Un odore salmastro si diffonde per la serra.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>Una punticina azzurrina emerge dal terreno.</i>
          -> main
          
    = step_due
        <i>Le punte sono aumentate, e roteano nell'aria a incredibile velocità, senza alcun rumore.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
          -> main
          
    = step_tre
        <i>L'odore è così forte da farti lacrimare gli occhi.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        ...
        <i>Forti nella loro distruzione, estremamente fragili.</i>
            ...
            + (colto) [Fermo il lichene.]
                ~ growthLicheneDegliAbissi = stepZero
                <i>Un piccolo sbuffo, rimane solo un foro.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
...
//Outcome: datti piacere
    = step_zero
    ~ growthMuschioDelleAmanti = stepZero
        <i>È solo una tua impressione, o il vaso ha iniziato a brillare?</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        -> main
    
    = step_uno
        <i>Nettare color rame sale lungo le corde che reggono il vaso.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
          -> main
          
    = step_due
        <i>Il nettare si è intrecciato, arrotolato, cerca le venature del legno della serra.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>Lo saggia, si mischia, lo penetra.</i>
        <i>Foglie rosastre nascono da questa unione.</i>
          -> main
    
    = step_tre
        <i>Calore nel ventre.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
...
//Outcome: danza, sola o con le compagne
    = step_zero
        ~ growthCantoDelleCompagne = stepZero
        <i>Qualcosa vibra e ti sveglia le gambe.<i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>Hai voglia di danzare.</i>
            -> main
        
    = step_uno
        <i>Il vaso è caldo al tocco.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>L'umidità del terreno evapora creando una nebbiolina rossastra.</i>
          -> main
          
    = step_due
        <i>La nebbia si è fatta ora goccia, goccie rosse che vibrano.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>Che si rincorrono e si tuffano nel vaso.</i>
        <i>E quando si scontrano, la serra riecheggia di una festosa risata.</i>
            -> main
          
    = step_tre
        <i>La serra vibra e si scuote, persino le travi sembrano voler danzare.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        ...
        + (colto)[È il momento di festeggiare.]
                <i>Il canto ti invita alla danza.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
...
//Outcome: prometti di dire qualcosa che ti pesa sullo stomaco.
    = step_zero
    ~ growthLaSpazzata = stepZero
        <i>Niente sembra cambiare.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>Eppure l'aria sembra più pesante.</i>
            -> main
         
    = step_uno
         <i>Qualcosa sembra osservarti dagli angoli più scuri della serra.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
         <i>L'aria ti manca, hai voglia di gridare.</i>
            -> main
    
    = step_due
        <i>C'è un forte vibrare.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>Cose sottili riempiono i tuoi occhi di fastidio.</i>
        <i>Della voglia di stringere, percuotere, sbattere qualcosa.</i>
            -> main
    
    = step_tre
        <i>Il tetto della serra scricchiola, le sue travi sembrano gemere dal dolore.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        ...
        + (colto)[Sfioro i suoi rami.]
            <i>Una forte contrazione.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
...
//Outcome: liberazione, invito ad avanzare
    ...
    = step_uno
        <i>Rami come dita rattrappite sembrano artigliare l'aria.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
            -> main
    
    = step_due
        <i>Le dita ora sono sollevate in una mano nervosa.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
          -> main
          
    = step_tre
        <i>La mano, ora tesa verso il cielo, sembra squarciata da una resina rossastra.<i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
...
//Outcome: ricordo di chi non c'è più
    = step_zero
        ~ growthNonTiScordarDiTe = stepZero
        <i>Su uno vecchio ramo è comparsa una sostanza gelatinosa, una gomma che sembra un asparago.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
            -> main
    
    = step_uno
        <i>Il ramo sembra più leggero, vitreo.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
    ...
    = step_due
        <i>Il ramo sembra sparire nella luce della serra.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>No, non sparire: è trasparente.</i>
        <i>Gioca con la luce, la rende calda e accogliente.</i>
          -> main
          
    = step_tre
        <i>Ramo e sostanza sono una cosa sola: un fungo di vetro, dita che si sfiorano e intrecciano lanciate verso il cielo.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        ...
        + (colto) [Intreccio le mie dita alle sue.]
            <i>Ti metti a piangere.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
...
//Outcome: prova una strada nuova
    = step_zero
        ~ growthBrinaDellImpossibile = stepZero
        <i>Qualcosa ha rotto un vetro della serra?</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
            -> main
    
    = step_uno
        <i>Le crepe si sono fatte ora più fitte, investendo anche il vaso.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
          -> main
          
    = step_due
        <i>Vaso, vetro e mobile: linee nette mostrano il cielo fuori dalla serra.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        <i>Eppure non sembrano cadere, non sembrano tentennare.</i>
          -> main
    
    = step_tre
        <i>Isole di vetro, terracotta e legno galleggiano nell'aria.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
        ...
        + (colto) [Infilo la mano tra gli spazi vuoti.]
            <i>Il vetro si rinsalda, spingendo via la tua mano.</i> #speaker:{fungus_tag()}#inkA: offState #inkB:offState #inkC:offState  #inkD:offState
