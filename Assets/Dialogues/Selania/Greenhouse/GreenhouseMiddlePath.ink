...
=== the_frog
    ...
    + (talkFrog) {are_two_entities_together(TheFrog, PG)} [TheFrog]
        <i>Una rana bluastra ti osserva incuriosita.</i> #speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
            ...
            - (top)
                ...
                * * (frog) [{charNameTwo} dice che hai un regalo per me.]
                    <i>La rana si silenza per un istante.</i> #speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                    Cra?#speaker:{frog_tag()} #inkA:offState #inkB:offState #inkC:offState  #inkD:offState #portrait:frog_neutral
                    Cra Cra Cra!
                    Crrrrrrrrrrra!
                    <i>La rana sta dicendo che spesso il ragazzino viene sulle sponde dello stagno e chiacchiera.</i>#speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                    ...
                    <i>Tranne della nonna e del fratello.</i>#speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                    Cra!#speaker:{frog_tag()} #inkA:offState #inkB:offState #inkC:offState  #inkD:offState #portrait:frog_neutral
                    <i>Al bambino non piacciono gli adulti perché non sono coerenti.</i> #speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                    ...
                    <i>Ma che sta anche a te decidere che fare alla fine.</i>#speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                ...
                * * {frog && firstStory == Active} [Puoi aiutarmi anche per {charNameOne}?]
                    <i>La rana sembra rifletterci.</i>#speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                    Cra.#speaker:{frog_tag()} #inkA:offState #inkB:offState #inkC:offState  #inkD:offState #portrait:frog_neutral
                    <i>La rana accetta, ma non promette di essere così disponibile in futuro.</i>#speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                    CRRRRRRACC. Crac. Cra?#speaker:{frog_tag()} #inkA:offState #inkB:offState #inkC:offState  #inkD:offState #portrait:frog_neutral
                    <i>L'unica cosa certa è che {charNameOne} DETESTA le persone troppo razionali.</i>#speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                    ...
                    Cra.
                    <i>E che quando si siede qui sullo stagno, parla molto di spiritualità.</i>#speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                    ...
                    <i>E chiede se la prossima volta le porti uno stuzzichino, perché ha molta fame.</i>#speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
                        -> top
