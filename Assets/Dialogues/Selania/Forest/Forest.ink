...
+ {are_two_entities_together(Bench, PG)} [Bench]
    <i>La panchina vibra, attendendo la sua ricostruzione.</i> #speaker:{fungus_tag()} #inkA: offState #inkB:offState #inkC:offState  #inkD:offState  #portrait: {fungus_state()}
        -> main
