...
*******************************************/
{
    ...
    //Boccale dalla strega
        ...
        - grimoire_thirdChar hasnt grimWitchThirdChar && ((grimoire_thirdChar has grimThirdCharMentor) or (grimoire_thirdChar has grimFirstThirdChar) or (thirdChar_firstCharRage == true)) && witch_thirdCharSummoned == false && png_commonPauseTalking == false && grimoire_thirdChar has grimThirdOpenNest:
