   ...
   {charNameUno}: Come mi dovrei chiamare secondo te?
    ...
    {charNameUno}: Merda, faccio davvero schifo a parlare.
        ...
        + [Opzione che aumenta il viola]
            ~ firstPurple ++
        -
    {charNameUno}: Continua a tornarmi in mente un ricordo.
    ...
    {charNameUno}: Ma ogni tanto ci permetteva di sentire le vecchie registrazioni, di quando nonno suonava e cantava nella balera.
