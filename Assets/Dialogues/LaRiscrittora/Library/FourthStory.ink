...
=== beatrice_sgravatto
<i>TITOLO</i> di Beatrice Sgravatto (PPP/uuu)
    + Vorrei leggere ancora
       -> book_test_intro
    + Me ne vado  
    -> main
...
<i>Titolo</i> di Queerginia Wolf/Marco Spelgatti (she/he/they)
    ...
    Ci hanno messo tre ore a cancellare i tuoi decenni.
    ...
    Eppure.
    Stasera, tornando, portando il cane vicino alla tua carcassa, abbiamo notato un pollone.
    Tenace e piccolino teso verso l'alto, i rami ancora gemme, la corteccia morbida e rigata.
    Le macchine che ti hanno tagliato moriranno. Spariranno gli uomini che le hanno comandate.
