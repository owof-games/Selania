      ...
      if (original != null) path = AssetDatabase.GetAssetPath(original);
        ...
        void DisplayModifiers(List<IMaterialPropertyModifier> modifiers)
        {
            ...
            if (modifiers.Count == 0)
                EditorGUILayout.HelpBox("Select a value from the dropdown to add a property modifier",
                    MessageType.Info);
...
#pragma warning restore CS0168 // Variable is declared but never used
        ...
        )
        {
            ...
            MaterialProperty materialProperty =
                MaterialEditor.GetMaterialProperty(_editorMaterialArray, modifier.PropertyName);

            ShaderPropertyFlags oldFlags = materialProperty.propertyFlags;
            ShaderPropertyFlags flags = oldFlags;
            ...
            if (GraphicMaterialOverrideHelper.OverridePropertyColor(materialProperty, (Object)modifier,
        ...
        /// </summary>
        /// <returns></returns>
        PropertyEntry? DisplayCreationPopup(List<IMaterialPropertyModifier> modifiers,
            List<ShaderPropertyInfo> properties)
        {
