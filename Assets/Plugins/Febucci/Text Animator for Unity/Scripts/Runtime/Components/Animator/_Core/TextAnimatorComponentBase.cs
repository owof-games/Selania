...
namespace Febucci.TextAnimatorForUnity
{
    ...
    public abstract class TextAnimatorComponentBase : MonoBehaviour, ISettingsProvider<AnimatorSettings>,
        ITextAnimatorProvider
    {
        [SerializeField] public AnimatorSettings localSettings = new();
        ...
        public AnimatorSettings Settings => sharedSettings != null ? sharedSettings.Settings : localSettings;
        ...
        // -- Databases --
        // ----------------
        [FormerlySerializedAs("databaseBehaviors")] [SerializeField]
        private AnimationsDatabase databaseEffects;

        /// <summary>
        ///     Behaviors Database used by this Text Animator, in addition to the global ones found in
        ///     <see cref="TextAnimatorSettings" /> asset.
        /// </summary>
