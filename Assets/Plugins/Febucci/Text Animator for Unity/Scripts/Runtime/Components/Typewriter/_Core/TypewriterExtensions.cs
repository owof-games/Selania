...
namespace Febucci.TextAnimatorForUnity
{
    ...
    {
        public static TypewriterComponent InstantiateTypewriter(this ITextAnimatorProvider animatorProvider,
            ActionDatabase database, TypingsTimingsScriptableBase typewriterSettings)
        {
