...
namespace Febucci.TextAnimatorForUnity
{
    ...
    /// </summary>
    /// <remarks>
    ///     If you want to use the built-in Typewriter, see: <see cref="TypingDelaysByCharacter" /> or
    ///     <see cref="TypingDelaysByWord" /><br />
    ///     <br />
    ...
    public class TypewriterComponent : MonoBehaviour, ITypewriterProvider, ISettingsProvider<TypewriterSettings>,
        IDatabaseProvider<ITypewriterAction>
    {
        [SerializeField] private TypingsTimingsScriptableBase timingsScriptableBase;

        [SerializeField] private ActionDatabase actionsDatabase;
        ...
        TypewriterSettings ISettingsProvider<TypewriterSettings>.Settings =>
            sharedSettings != null ? sharedSettings.Settings : localSettings;
        ...
        private void InitializeOnce()
        {
            ...
            _wrapper = new TypewriterCore(animator, this,
                ...
                OnBeforeShowingCharacter,
                OnAfterWaitingCharacter);
            ...
            _wrapper.ShowText(animator
                .TextFull); // re-parses with typewriter actions to prevent ignoring them (if they're already present)
            initialized = true;
        }

        internal void AssignAnimator(ITextAnimatorProvider animator, ActionDatabase actionsDatabase,
            TypingsTimingsScriptableBase timingsScriptableBase)
        {
        ...
        /// </summary>
        /// <remarks>
        ///     Usually users don't want to wait for the very last letter(s), similar to punctuation. That said, this option might
        ///     come useful in cases like you have very slow letters.
        /// </remarks>
        [Tooltip(
        ...
        /// <summary>
        ///     <c>true</c> if you want to wait for every single character to animate before invoking
        ///     <see cref="onTextDisappeared" />.
        ///     Otherwise, you might have that event invoked even if the very last character(s) are animating.
        /// </summary>
        /// <remarks>
        ///     Usually users don't want to wait for the very last letter(s), similar to punctuation. That said, this option might
        ...
        /// </summary>
        public CharacterWaitEvent onCharacterWaitStarted = new();

        /// <summary>
        ///     Invoked after the typewriter has finished waiting for a character
        /// </summary>
        public CharacterWaitEvent onCharacterWaitFinished = new();
        ...
        /// </example>
        /// <remarks>
        ///     This is 99% used in custom integrations for custom typewriters. If you want to implement different wait times for
        ///     characters
        ///     instead, please use "Custom Typewriter Waits" and create a custom scriptable:
        ///     https://docs.febucci.com/text-animator-unity/writing-custom-classes/writing-custom-typing-waits-c
        /// </remarks>
